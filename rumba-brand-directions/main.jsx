// Rumba · Brand Directions — canvas with 10 design directions + a 16-variant logo lab
  ...
  <div style={{
    ...
    <div>
      ...
      <div style={{ fontFamily: "'Rubik', sans-serif", fontWeight: 900, fontSize: 200, lineHeight: 0.88, letterSpacing: '-0.05em', textTransform: 'lowercase', marginTop: 36 }}>
        ten directions.<br/><span style={{ color: '#e84c8a' }}>one logo.</span>
      </div>
    </div>
    ...
    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1.5fr', gap: 80, marginTop: 30 }}>
      <div style={{ fontFamily: "'DM Serif Display', serif", fontStyle: 'italic', fontSize: 30, lineHeight: 1.25, color: '#f4c324' }}>
        Start at the Logo Lab. Then scan the ten directions. Tell us which lockup types right and which direction lands — we ship the rest from there.
      </div>
      <div style={{ fontSize: 16, lineHeight: 1.6, opacity: 0.85, columns: 2, columnGap: 36 }}>
        <p style={{ margin: '0 0 1em' }}>The current AI-generated mark + the Gaceta site lean &ldquo;curated travel mag.&rdquo; The product is nightlife. These ten directions cover the range — from poster-rough to brutalist to type-only.</p>
        <p style={{ margin: 0 }}>Recommended baseline: <strong style={{ color: '#fff8de' }}>06 Feria-aligned</strong> palette + <strong style={{ color: '#fff8de' }}>Logo Lab #01 or #03</strong>. But hold judgment until you&rsquo;ve scrolled all ten.</p>
      </div>
    </div>
  </div>
);
...
const App = () => (
  <DesignCanvas title="Rumba — 10 directions + Logo Lab">
